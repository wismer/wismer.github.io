...
var QueryBar = React.createClass({displayName: 'QueryBar',
  ...
  render: function() {
    ...
    var newSets = this.state.currentSets.map(function(set){
      return React.createElement(Expansion, React.__spread({},  set))
    })

    return (
      React.createElement("div", {id: "expansions"}, 
        React.createElement("input", {onKeyDown: this.query, type: "text"}), 
...
var Expansion = React.createClass({displayName: 'Expansion',
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "set"}, set.name)
    )
  }
})
...
var renderStuff = function() {
  React.render(
    React.createElement(QueryBar, {url: "http://mtgjson.com/json/SetList.json"}),
